<?php
/* PHP Version of Land Explorer. $Id: le-w-river.php,v 1.12 2012/05/10 19:16:35 ytian Exp ytian $
*/
...
$clevs["fmap"]='0 10 20 50 100 200'; 
$clevs["runoff"]='5 100 500 1000 5000 10000';
$clevs["rain"]='0 1 2 3 4 5 10'; 
$clevs["rain1d"]='5 10 25 50 100 150 300'; 
$clevs["rain3d"]='5 10 25 50 100 150 300'; 
$clevs["rain7d"]='5 10 25 50 100 150 300'; 
$clevs["onew"]='0 20 40 60 80 100 120 140'; 
$clevs["level"]='1 2 3 4 5 6 7'; 
#$clevs["onesto"]='0 1 2 4 8 16 32 64 128'; 
$clevs["onesto"]='2 5 10 100 1000 10000'; 
$clevs["oneexc"]=''; 
...
$title["fmap"]='Flood Detection/Intensity (depth above threshold [mm])\\';
$title["runoff"]='Stream flow [m^3/s]';
$title["rain"]='Rainfall (Instantaneous) [mm/h]'; 
$title["rain1d"]='Rainfall (1-day accum.) [mm]'; 
$title["rain3d"]='Rainfall (3-day accum.) [mm]'; 
$title["rain7d"]='Rainfall (7-day accum.) [mm]'; 
$title["onew"]='Soil moisture [mm]'; 
$title["level"]='Flood level'; 
$title["onesto"]='Routed Runoff [mm]'; 
$title["oneexc"]='Direct runoff [mm]'; 
$title["p95"]='Relative Routed Runoff (> 95th Pctl) [mm]'; 
...
set clevs $clevs[$var]
set ccols $cclrs[$var]
define tm4=tm3.2(t=1)
*d maskout(onesto-tm3.2(t=1), onesto-tm3.2(t=1)-5)
d maskout(onesto-tm4, onesto-tm4-5)
...
<${metas}META http-equiv="refresh" content="1; url=le-w-river.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&tp=$tp&at1=$at1&at2=$at2&a=1"$metae>
...
<a href="le-w-river.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=u"> <img src="images/ua.gif" border=0> </a>
</td></tr>
<tr><td>
<a href="le-w-river.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=l"> <img src="images/la.gif" border=0> </a>
</td>
    <td> &nbsp; &nbsp; &nbsp; &nbsp; </td>
    <td>
<a href="le-w-river.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=r"> <img src="images/ra.gif" border=0> </a>
</td></tr>
<tr>
<td colspan=3 align=center>
<a href="le-w-river.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=d"> <img src="images/da.gif" border=0> </a>
</td>
</tr>
</table>
</center>
...
<table cellpadding=4>
<tr><td>
<a href="le-w-river.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&ZM=1"> <img src="images/zi.gif" border=0> </a></td></tr>
<tr><td>
<a href="le-w-river.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&ZM=-1"> <img src="images/zo.gif" border=0> </a></td></tr>
</table>
</center>
</div>
<!--div id="typebox">
<form method="post" action="le-w-river.php">
...
<b>Select variable: </b>
<select name="var">
<option value="fmap" ${select['fmap']} > Flood detection
<!--option value="p95" ${select['p95']} > Relative routed runoff -->
<option value="runoff" ${select['runoff']} >Stream flow
<!--option value="level" ${select['level']} >Flood level  -->
<!--option value="onesto" ${select['onesto']} >Routed runoff -->
<!--option value="onew" ${select['onew']} >Soil moisture  -->
<option value="rain" ${select['rain']} >Rainfall (Inst.)
<option value="rain1d" ${select['rain1d']} >Rainfall (1-day)
<option value="rain3d" ${select['rain3d']} >Rainfall (3-day)
<option value="rain7d" ${select['rain7d']} >Rainfall (7-day)
<!--option value="oneexc" ${select['oneexc']} > Direct runoff  -->
</select>
<input type="submit" value="Plot">
</form>
</div>
...
<div id="exitbox">
<center>
<a href="le-w-river.php?var=$var"><input type="submit" value="Reset"></a>
</center>
</div>
...
<center>
<table> <tr>
<td> <a href="le-w-river.php?ct=$pt&var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&t=$t&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp"> 
<b>Previous time step << </b></a>  </td> 
<td>&nbsp; &nbsp;&nbsp; &nbsp;  </td>
<td> <a href="le-w-river.php?ct=$nt&var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&t=$t&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp"> 
