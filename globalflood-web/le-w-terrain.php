<?php
/* PHP Version of Land Explorer. $Id: le.php,v 1.4 2011/01/15 17:38:13 ytian Exp ytian $
*/
...
$clevs["runoff"]='0 10 100 1000 10000 100000';
...
// threshold values below which are not plotted
$thrs["runoff"] = 10; 
$thrs["rain"] = 0.5;  
$thrs["onew"] = 0; 
$thrs["level"] = 0.5;
...
$title["p95"]='Relative routed runoff'; 
...
$output=`export GADDIR=$GADDIR; export GASCRP=$GASCRP; export TERM=vt100; $GRADS -bl <<EOFC
open $ctlf
open $basedir/elev_GTOPO30.ctl 
open $basedir/elev_GTOPO30-1dn.ctl 
set grads off
set mpdset hires
set xlopts 1 6.0 0.15
set ylopts 1 6.0 0.15
...
*set clevs  0 25 50 100 200 400 800' 
set clevs  0 10 20 40 80 160 320 640' 
set ccols 20 21 22 23  24  25  26  27 28
set clab off 
set gxout shaded 
d elev.3(t=1)-elev.2(t=1)
set gxout $type[$tp]
set clevs $clevs[$var]
set ccols $cclrs[$var]
...
<${metas}META http-equiv="refresh" content="1; url=le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&tp=$tp&at1=$at1&at2=$at2&a=1"$metae>
...
<a href="le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=u"> <img src="images/ua.gif" border=0> </a>
</td></tr>
<tr><td>
<a href="le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=l"> <img src="images/la.gif" border=0> </a>
</td>
    <td> &nbsp; &nbsp; &nbsp; &nbsp; </td>
    <td>
<a href="le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=r"> <img src="images/ra.gif" border=0> </a>
</td></tr>
<tr>
<td colspan=3 align=center>
<a href="le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=d"> <img src="images/da.gif" border=0> </a>
</td>
</tr>
</table>
</center>
...
<table cellpadding=4>
<tr><td>
<a href="le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&ZM=1"> <img src="images/zi.gif" border=0> </a></td></tr>
<tr><td>
<a href="le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&ZM=-1"> <img src="images/zo.gif" border=0> </a></td></tr>
</table>
</center>
</div>
<div id="typebox">
...
<option value="rain" ${select['rain']} >Rainfall
...
<div id="exitbox">
<center>
<a href="le.php"><input type="submit" value="Reset"></a>
</center>
</div>
...
<center>
<table> <tr>
<td> <a href="le.php?ct=$pt&var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&t=$t&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp"> 
<b>Previous time step << </b></a>  </td> 
<td>&nbsp; &nbsp;&nbsp; &nbsp;  </td>
<td> <a href="le.php?ct=$nt&var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&t=$t&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp"> 
