<?php
/* PHP Version of Land Explorer 
   with time-series display on mouse click on the map.  
$Id: js-le.php,v 1.3 2013/02/20 15:58:06 ytian Exp ytian $ 
*/
...
my-cbarn $unit[$ctl] 
printim $imgdir/$var-$pid.gif gif white x792 y612
quit
EOF`;

$output1=str_replace("\n", " ", $output); 
if (preg_match("/xxxx.*\sX = (.*?)\s+Y = (.*?)\s+.*X = (.*?)\s+Y = (.*?)\s+.*yyyy/", 
   $output1, $ma)) {  
  $output="$output x1=$ma[1] y1=$ma[2] x2=$ma[3] y2=$ma[4]"; 
} else { 
...
<${metas}META http-equiv="refresh" content="1; url=js-le.php?ctl=$ctl&var=$var&dt=$dt&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&tp=$tp&at1=$at1&at2=$at2&a=1"$metae>
 ...
 function getAbsoluteOffset(htmlelement) {
  ...
  return offset;
     ...
     function onMouseOver(e){
       ...
       y = 8.5*72 - y; 
       // convert to lat/lon
       var lon = $lon1 + (x - x1)/( x2 - x1) * ($lon2 - $lon1) 
       var lat = $lat1 + (y - y1)/( y2 - y1) * ($lat2 - $lat1) 
       // round short
     ...
     function onMouseClick(e){
       ...
       document.getElementById('lat0').value = lat;
       document.getElementById('lon0').value = lon;
       location.href="js-le.php?var=$var&TS=1&lat0="+lat+"&lon0="+lon+"&ct=$ct&ctl=$ctl&dt=$dt&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&at1=$at1&at2=$at2"; 
     }
...
<body>
<div id="leftbox">
<img src="$imgurl" border=0 align=right onmousemove="onMouseOver.call(this, event)" 
...
<a href="js-le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&ctl=$ctl&dt=$dt&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=u"> <img src="images/ua.gif" border=0> </a>
</td></tr>
<tr><td>
<a href="js-le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&ctl=$ctl&dt=$dt&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=l"> <img src="images/la.gif" border=0> </a>
</td>
    <td> &nbsp; &nbsp; &nbsp; &nbsp; </td>
    <td>
<a href="js-le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&ctl=$ctl&dt=$dt&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=r"> <img src="images/ra.gif" border=0> </a>
</td></tr>
<tr>
<td colspan=3 align=center>
<a href="js-le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&ctl=$ctl&dt=$dt&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&P=d"> <img src="images/da.gif" border=0> </a>
</td>
</tr>
</table>
</center>
...
<table cellpadding=4>
<tr><td>
<a href="js-le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&ctl=$ctl&dt=$dt&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&ZM=1"> <img src="images/zi.gif" border=0> </a></td></tr>
<tr><td>
<a href="js-le.php?var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&ct=$ct&ctl=$ctl&dt=$dt&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp&ZM=-1"> <img src="images/zo.gif" border=0> </a></td></tr>
</table>
</center>
</div>
<div id="typebox">
<form method="post" action="js-le.php">
...
<b>Jump to (lon, lat):<br> </b>
<table cellpadding=0 cellspacing=0>
<tr><td> <input type="text" name="lon0" maxlength=8 size=6 value="$lon0" id="lon0"></td>
    <td> <input type="text" name="lat0" maxlength=8 size=6 value="$lat0" id="lat0"></td> </tr>
<tr>
...
<div id="exitbox">
<center>
<a href="js-le.php?var=$var&ct=$ct&ctl=$ctl&dt=$dt"><input type="submit" value="Reset" onclick="window.location='js-le.php?var=$var&ct=$ct&ctl=$ctl&dt=$dt'"></a>
</center>
</div>
...
<center>
<table> <tr>
<td> <a href="js-le.php?ctl=$ctl&ct=$pt&dt=$dt&var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&t=$t&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp"> 
<b>Previous time step << </b></a>  </td> 
<td>&nbsp; &nbsp;&nbsp; &nbsp;  </td>
<td> <a href="js-le.php?ctl=$ctl&ct=$nt&dt=$dt&var=$var&lat1=$lat1&lat2=$lat2&lon1=$lon1&lon2=$lon2&t=$t&z=$z&T=$T&Z=$Z&E=$E&W=$W&S=$S&N=$N&tp=$tp"> 
